...
namespace Baitkm.Controllers
{
    ...
    public class AnnouncementController : BaseController
    {
        ...
        [Authorize(Roles = Roles.User)]
        [UserAuthorize]
        public async Task<IActionResult> AddCompoundItem([FromBody] AddCompoundItemModel compoundItem)
        {
            return await MakeActionCallAsync(async () => await _service.AddCompoundItem(compoundItem, GetPersonId()));
        }

        [HttpPut]
        [Authorize(Roles = Roles.User)]
        [UserAuthorize]
        public async Task<IActionResult> EditCompoundItem([FromBody] AddCompoundItemModel compoundItem)
        {
            return await MakeActionCallAsync(async () => await _service.EditCompoundItem(compoundItem, GetPersonId()));
        }
        ...
        public async Task<IActionResult> Callback(string path)
        {
            ...
            HttpContext.Request.Headers.TryGetValue("announcementType", out var announcementType);
            ...
            return await MakeActionCallAsync(async () => await _service.UploadCallback(path, announcementId, announcementPhotoType, announcementType));
        }
        ...
        [AllowAnonymous]
        [UserGuestAuthorize]
        public async Task<IActionResult> Watched(int announcementId)
        {
            return await MakeActionCallAsync(async () =>
                await _service.WatchedAsync(announcementId, GetPersonId(), GetDeviceId(), GetLanguage()));
        }
        ...
        [AllowAnonymous]
        [UserGuestAuthorize]
        public async Task<IActionResult> UnWatched(int announcementId)
        {
            return await MakeActionCallAsync(async () =>
                await _service.UnWatchedAsync(announcementId, GetPersonId(), GetDeviceId(), GetLanguage()));
        }

        [HttpGet]
        [AllowAnonymous]
        [UserGuestAuthorize]
        public async Task<IActionResult> WatchedList([FromQuery] SortingType sortingType)
        {
            return await MakeActionCallAsync(async () =>
                await _service.WatchedListAsync(GetPersonId(), GetDeviceId(), GetLanguage(), sortingType));
        }
        ...
        [AllowAnonymous]
        [UserGuestAuthorize]
        public async Task<IActionResult> NearbyMobile([FromBody] MobileNearByModel model)
        {
        ...
        [AdminAuthorize]
        [Route("{announcementId}")]
        public async Task<IActionResult> RemoveFromTopList(int announcementId)
        {
            return await MakeActionCallAsync(async () => await _service.RemoveFromTopListAsync(GetLanguage(), announcementId));
        }

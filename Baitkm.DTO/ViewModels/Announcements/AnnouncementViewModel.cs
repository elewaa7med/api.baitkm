...
namespace Baitkm.DTO.ViewModels.Announcements
{
    public class AnnouncementViewModel : IViewModel
    {
        ...
        public bool IsProfileNumber { get; set; }
        public string WhatsApp { get; set; }
        public string WhatsAppCountryCode { get; set; }
        public string RealAgentCompanyName { get; set; }
        public double UserRate { get; set; }

        public string UserDescritpion { get; set; }
        public double? currentRating { get; set; }

        public List<CompoundItemListViewModel> compoundItems { get; set; }
    }

...
namespace Baitkm.BLL.Services.Announcements
{
    public interface IAnnouncementService
    {
        ...
        Task<int> AddCompoundItem(AddCompoundItemModel compoundItemModel, int userId);
        Task<bool> EditCompoundItem(AddCompoundItemModel compoundItemModel, int userId);
        ...
        Task<bool> UploadCallback(string path, int announcementId, AttachmentType announcementPhotoType,string type);
        ...
        Task<bool> WatchedAsync(int announcementId, int userId, string deviceId, Language language);
        Task<bool> UnWatchedAsync(int announcementId, int userId, string deviceId, Language language);
        Task<IEnumerable<AnnouncementViewModel>> WatchedListAsync(int userId, string deviceId, Language language, SortingType sortingType);
        ...
        Task<PagingResponseModel<AnnouncementViewModel>> SimilarAnnouncementAsync(PagingRequestModel model, int announcementId,
            int userId, string deviceId, Language language);
        Task<PagingResponseForSuggesting<AnnouncementViewModel>> NearbyMobileAsync(MobileNearByModel model,
        ...
        Task<bool> RemoveFromTopListAsync(Language language, int announcementId);
